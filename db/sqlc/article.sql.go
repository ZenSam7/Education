...
WHERE
    ...
    authors = CASE WHEN $4::integer[] <> authors
        THEN $5::integer[]
        ELSE authors END
LIMIT $7::integer
OFFSET $6::integer
...
ORDER BY
        ...
        CASE WHEN $5::boolean THEN id_article::integer
             WHEN $6::boolean THEN evaluation::integer END
        , -- запятая
        CASE WHEN $7::boolean THEN comments::integer[]
             WHEN $8::boolean THEN authors::integer[] END
        , -- запятая
        CASE WHEN $9::boolean THEN title::text
             WHEN $10::boolean THEN text::text END
        , -- запятая
        CASE WHEN $11::boolean THEN edited_at::timestamp
             WHEN $12::boolean THEN created_at::timestamp END
